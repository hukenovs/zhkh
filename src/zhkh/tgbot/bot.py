...
from .format import build_text_summary
...
HELP_TEXT = (
    ...
    "/help — эта справка\n\n"
    "Нажмите кнопку <b>«Запросить квитанции»</b> — бот зайдёт во все "
    "настроенные личные кабинеты, скачает свежие квитанции, пришлёт "
    "текстовое саммари по суммам к оплате и сами файлы квитанций.\n\n"
...
def _keyboard() -> InlineKeyboardMarkup:
    return InlineKeyboardMarkup(
        [[InlineKeyboardButton("Запросить квитанции", callback_data=REQUEST_RECEIPTS)]]
    )
...
async def cmd_help(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    await update.message.reply_text(
        HELP_TEXT, parse_mode="HTML", reply_markup=_keyboard()
    )
